    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl gap-14 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        ...
        <div className="relative">
          ...
          <div className="relative rounded-[2rem] border border-sky-400/20 bg-slate-950/80 p-6 shadow-2xl shadow-sky-950/40 backdrop-blur">
            <div className="mb-6 flex items-center justify-between border-b border-sky-400/10 pb-5">
              <div>
              ...
              <div className="h-12 w-12 rounded-2xl border border-sky-400/30 bg-sky-400/10" />
            </div>
              ...
              {content.services.items.map((service, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-sky-400/10 text-sm font-bold text-sky-300 ring-1 ring-sky-400/20">
